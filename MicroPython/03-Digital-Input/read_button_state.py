...
Description: Reads and prints the state of a button connected to GPIO 7.
...
- Tutorial [EN]: https://docs.waveshare.com/ESP32-MicroPython-Tutorials/Digital-IO#digital-input
"""
